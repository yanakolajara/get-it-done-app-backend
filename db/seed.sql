...
-- Parent tasks
INSERT INTO 
    parentTasks(user_id,details_id,content,progress_state,is_staged,date)
VALUES
    (1, 1, 'Clean my desk', 2, false, '2024-03-06'),
    (1, 1, 'Organize closet', 1, true, '2024-03-06'),
    (2, 2, 'Study for exam', 1, false, '2024-03-10'),
    (2, 2, 'Exercise routine', 3, true, '2024-03-12'),
    (3, 3, 'Task 1 for John', 1, false, '2024-03-14'),
    (3, 3, 'Task 2 for John', 2, true, '2024-03-16'),
    (4, 4, 'Task 1 for Alice', 2, false, '2024-03-18'),
    (4, 4, 'Task 2 for Alice', 3, true, '2024-03-20'),
    (5, 5, 'Task 1 for Bob', 1, false, '2024-03-22'),
    (5, 5, 'Task 2 for Bob', 2, true, '2024-03-24'),
    (6, 6, 'Task 1 for Emma', 2, false, '2024-03-26'),
    (6, 6, 'Task 2 for Emma', 3, true, '2024-03-28'),
    (7, 7, 'Task 1 for Michael', 1, false, '2024-03-30'),
    (7, 7, 'Task 2 for Michael', 2, true, '2024-03-30'),
    (7, 7, 'Task 3 for Michael', 2, true, '2024-03-31'),
    (8, 8, 'Task 1 for Sophia', 2, false, '2024-04-03'),
    (8, 8, 'Task 2 for Sophia', 3, true, '2024-04-05'),
    (9, 9, 'Task 1 for David', 1, false, '2024-04-07'),
    (9, 9, 'Task 2 for David', 2, true, '2024-04-09'),
    (10, 10, 'Task 1 for Olivia', 2, false, '2024-04-11'),
    (10, 10, 'Task 2 for Olivia', 3, true, '2024-04-13'),
    (11, 11, 'Task 1 for James', 1, false, '2024-04-15'),
    (11, 11, 'Task 2 for James', 2, true, '2024-04-17'),
    (12, 12, 'Task 1 for Emily', 2, false, '2024-04-19'),
    (12, 12, 'Task 2 for Emily', 3, true, '2024-04-21'),
    (13, 13, 'Task 1 for Daniel', 1, false, '2024-04-23'),
    (13, 13, 'Task 2 for Daniel', 2, true, '2024-04-25'),
    (14, 14, 'Task 1 for Ava', 2, false, '2024-04-27'),
    (14, 14, 'Task 2 for Ava', 3, true, '2024-04-29'),
    (15, 15, 'Task 1 for William', 1, false, '2024-05-01'),
    (15, 15, 'Task 2 for William', 2, true, '2024-05-03');
